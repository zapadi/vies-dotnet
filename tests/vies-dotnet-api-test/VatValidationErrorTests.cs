...
{
    [Theory]
    [InlineData("ATU1234567", VatValidationErrorCode.InvalidLength)] // Too short (8 chars)
    [InlineData("ATU123456789", VatValidationErrorCode.InvalidLength)] // Too long (10 chars)
    [InlineData("ATA12345678", VatValidationErrorCode.InvalidFormat)] // Wrong first char (A instead of U)
    [InlineData("ATU1234567X", VatValidationErrorCode.InvalidFormat)] // Non-digit in position 8
    [InlineData("ATUX2345678", VatValidationErrorCode.InvalidFormat)] // Non-digit in position 2
    [InlineData("ATU12345677", VatValidationErrorCode.InvalidCheckDigit)] // Invalid checksum
